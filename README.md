...
module "captain" {
  ...
  gluekube_docker_tag   = "v1.34.11-gluekube.6"
...
| <a name="input_gluekube_docker_tag"></a> [gluekube\_docker\_tag](#input\_gluekube\_docker\_tag) | n/a | `string` | `"v1.34.11-gluekube.6"` | no |
